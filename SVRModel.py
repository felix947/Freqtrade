...
class SVRModel(IFreqaiModel):
    ...
    def fit(self, data_dictionary: Dict, dk: FreqaiDataKitchen, **kwargs) -> Any:
        ...
        model = SVR()
        #param = {'kernel':['poly','rbf'],'C':[i for i in range(1,10)],'gamma':['scale','auto']}
        #SVR_CV = GridSearchCV(model,param,verbose=2,scoring='neg_mean_absolute_error')
