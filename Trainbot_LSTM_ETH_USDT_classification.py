...
def def_handler(sig,frame):
    print('\n\n[!] Saliendo ...')
    model.save('/Users/felix/Desktop/Bot_cripto/lstm_model_ETH/USDT_1m.h5')
    sys.exit(1)
signal.signal(signal.SIGINT,def_handler)
np.random.seed(2)
tf.random.set_seed(2)
df = pd.read_json('/Users/felix/Desktop/Bot_cripto/user_data/data/binance/futures/ETH_USDT-1m-futures.json')
...
y=pd.DataFrame(CreateTargets(data,1)).values
...
model.save('/Users/felix/Desktop/Bot_cripto/lstm_model_ETH/ETH_USDT_1m_classification.h5')
